...
#base = {'Cellar','Chapel','Moat','Chancellor','Village','Woodcutter','Workshop','Bureaucrat','Feast','Gardens','Militia','Moneylender','Remodel','Smithy','Spy','Thief','Throne Room','Council Room','Festival','Laboratory','Library','Market','Mine','Witch','Adventurer'}
#core = {'Copper','Silver','Gold','Platinum','Potion','Curse','Estate','Duchy','Province','Colony','Ruins'}
...
#        #print(kingdom_noise)
#
#        #gi = GameInfo(DEFAULT_MEAN,DEFAULT_MEAN/3,DEFAULT_MEAN/6*math.pow(kingdom_noise2/.2798,-1),DEFAULT_MEAN/300,.1,3)
#        #gi = GameInfo(DEFAULT_MEAN,DEFAULT_MEAN/3,DEFAULT_MEAN/6*math.pow(kingdom_noise2/.48966,10),DEFAULT_MEAN/300,.1,3)
#        gi = GameInfo(DEFAULT_MEAN,DEFAULT_MEAN/3,DEFAULT_MEAN/6,DEFAULT_MEAN/300,.1,3)
#    except:
#        gi = GameInfo(DEFAULT_MEAN,DEFAULT_MEAN/3,DEFAULT_MEAN/6,DEFAULT_MEAN/300,.1,3)
    ...
    #print("%d -> %d, %d -> %d (%s)" %(rate1,new_rate1,rate2,new_rate2,score[s1]))
...
#    #    continue
#    i += 1
#    #print("%02d. %s - %0.3f, %0.3f" % (i,key,noise_by_card[key]/mean_dev,noise_by_card[key]))
#
...
#        kd3 = kd3/kn
#        #print(kd)
#        #gi = GameInfo(DEFAULT_MEAN,DEFAULT_MEAN/3,DEFAULT_MEAN/6*math.exp(kd),DEFAULT_MEAN/300,.1,3)
#        #gi = GameInfo(DEFAULT_MEAN,DEFAULT_MEAN/3,DEFAULT_MEAN/6*math.exp(kd/10),DEFAULT_MEAN/300,.1,3)
#        gi = GameInfo(DEFAULT_MEAN,DEFAULT_MEAN/3,DEFAULT_MEAN/6*kd3,DEFAULT_MEAN/300,.1,3)
#        #print(kd2)
#        wexp = ec.expected_score(gi,rate1,rate2)
